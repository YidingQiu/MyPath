...
export default function LossOfJobPage() {
  ...
  if (showPersonaSelection) {
    return <PersonaSelection onConfirm={handlePersonaConfirm} highlightPersona="careerChanger" demoMode="loss-of-job" />
  }
