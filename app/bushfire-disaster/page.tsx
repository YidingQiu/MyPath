...
export default function BushfireDisasterPage() {
  const [selectedPersonas, setSelectedPersonas] = useState<Persona[]>([])
  const [currentStage, setCurrentStage] = useState<Stage>('crisis')
  ...
  if (showPersonaSelection) {
    return <PersonaSelection onConfirm={handlePersonaConfirm} highlightPersona="disasterAffected" demoMode="bushfire-disaster" />
  }
